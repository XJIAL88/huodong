...
export let getList = (obj) => {
  ...
  return axios.get(`${baseURL}/backend/activity/list`, {
      params: {
        adminId: '3',
...
export let getCategory = () => {
  return axios.get(`${baseURL}/backend/category/list/get`, {
    params: {
      adminId: '3',
      adminToken: 'bc4f4018a91aaaad7eb78327ee6d2949'
    },
...
export let getResource = (num) => {
  return axios.get(`${baseURL}/backend/resource/list/get`, {
    params: {
      adminId: '3',
      adminToken: 'bc4f4018a91aaaad7eb78327ee6d2949',
      category_id: num
...
export let create = (a, b, c, d, e) => {
  return axios.post(`${baseURL}/backend/activity/create`, {
    adminId: '3',
    adminToken: 'bc4f4018a91aaaad7eb78327ee6d2949',
    name: a,
    start_at: b,
...
export let detail = (num) => {
  return axios.get(`${baseURL}/backend/activity/detail`, {
    params: {
      adminId: '3',
      adminToken: 'bc4f4018a91aaaad7eb78327ee6d2949',
      id: num
...
export let update = (id, num) => {
  return axios.post(`${baseURL}/backend/activity/status/update`, {
    adminId: '3',
    adminToken: 'bc4f4018a91aaaad7eb78327ee6d2949',
    id: id,
    status: num,
...
//=>新增奖品
export let prize = () => {
  return axios.get(`${baseURL}/backend/all/activity/list`, {
    params: {
      adminId: '3',
      adminToken: 'bc4f4018a91aaaad7eb78327ee6d2949',
      status: '2',
...
export let toConfigure = (obj) => {
  ...
  return axios.post(`${baseURL}/backend/activity/award/set`, {
    adminId: '3',
    adminToken: 'bc4f4018a91aaaad7eb78327ee6d2949',
